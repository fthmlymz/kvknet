object frmKVKKOnemDereceTanim: TfrmKVKKOnemDereceTanim
  Left = 0
  Top = 0
  ClientHeight = 313
  ClientWidth = 478
  Caption = #214'nem Derecesi Bilgileri'
  ...
  object pnlData: TUniPanel
    ...
    object edTanim: TUniDBEdit
      ...
      Height = 22
      Hint = ''
      DataField = 'onemderece'
      DataSource = dsOnemDerece
  ...
  object dsOnemDerece: TUniDataSource
    DataSet = qOnemDerece
    Left = 291
    Top = 96
  end

object frmKVKKAmacTanim: TfrmKVKKAmacTanim
  Left = 0
  Top = 0
  ClientHeight = 304
  ClientWidth = 475
  Caption = 'Ama'#231' Bilgileri'
  ...
  object pnlData: TUniPanel
    ...
    object UniLabel3: TUniLabel
      ...
      AutoSize = False
      Caption = 'Ama'#231' Tan'#305'm'#305
      ParentFont = False
      Font.Color = clMaroon
      Font.OverrideDefaults = [ovFontHeight]
      TabOrder = 1
    end
    object edAmac: TUniDBEdit
      Left = 96
      Top = 10
      Width = 361
      Height = 22
  ...
  object qAmac: TUniQuery
    Connection = MainMod.DBMain
    SQL.Strings = (
      'SELECT * FROM def_data_amac')
    BeforePost = qAmacBeforePost
    Left = 174
    Top = 6
  end
end

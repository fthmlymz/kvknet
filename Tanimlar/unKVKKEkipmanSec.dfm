object frmKVKKEkipmanSec: TfrmKVKKEkipmanSec
  Left = 0
  Top = 0
  ClientHeight = 389
  ClientWidth = 616
  Caption = 'Ekipman (Donan'#305'm/Yaz'#305'l'#305'm/Hizmet) Listesi'
  ...
  object qEkipman: TUniQuery
    Connection = MainMod.DBMain
    SQL.Strings = (
      'SELECT * FROM def_data_ekipman'
      'ORDER BY ekipman')
    Left = 297
    Top = 90
  end

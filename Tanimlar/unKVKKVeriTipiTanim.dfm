object frmKVKKVeriTipiTanim: TfrmKVKKVeriTipiTanim
  Left = 0
  Top = 0
  ClientHeight = 294
  ClientWidth = 478
  Caption = 'KVKK Veri Tipi Bilgileri'
  ...
  object pnlData: TUniPanel
    ...
    object edNitelik: TUniComboBox
      ...
      Items.Strings = (
        'Belirtilmemi'#351
        'Ki'#351'isel Veri'
        #214'zel Nitelikli Ki'#351'isel Veri')
      TabOrder = 7
      IconItems = <>
    end
    object edKategoriCombo: TUniComboBox
      Left = 96
      Top = 15
      Width = 361
      Hint = ''

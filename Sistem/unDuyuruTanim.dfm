object frmDuyuruTanim: TfrmDuyuruTanim
  Left = 0
  Top = 0
  ClientHeight = 519
  ClientWidth = 714
  ...
  object pnlData: TUniPanel
    ...
    object UniLabel2: TUniLabel
      ...
      Alignment = taRightJustify
      AutoSize = False
      Caption = 'Duyuru Ba'#351'l'#305#287#305
      ParentFont = False
      Font.Color = clDefault
      Font.OverrideDefaults = [ovFontHeight]
      TabOrder = 2
    ...
    object edTarih: TUniDBDateTimePicker
      ...
      DataField = 'news_date'
      DataSource = dsDuyuru
      DateTime = 44285.000000000000000000
      DateFormat = 'dd.MM.yyyy'
      TimeFormat = 'HH:mm:ss'
      TabOrder = 6
    end
    object edKurum: TUniComboBox
      Left = 96
      Top = 8
      Width = 328
      Hint = ''

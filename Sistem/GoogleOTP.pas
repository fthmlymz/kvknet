...
uses
 ...
 {$IFNDEF FPC}System.SysUtils {$else}SysUtils{$ENDIF},math,
 // {$IFNDEF FPC}System.math{$ELSE}MATH{$ENDIF},
  Base32U,
  {$IFNDEF FPC}System.DateUtils{$ELSE}dateUtils{$ENDIF}
   {$IFNDEF FPC}, IdGlobal, IdHMACSHA1   {$ELSE}     , HMAC    {$IFEND};

//  {$IFNDEF FPC}System.{$ENDIF}SysUtils,
//  {$IFNDEF FPC}System.{$ENDIF}Math, Base32U,
//  {$IFNDEF FPC}System.{$ENDIF}DateUtils
//  {$IFNDEF FPC}
//    , IdGlobal, IdHMACSHA1
//  {$ELSE}
//    , HMAC

object frmAcikRizaKayitTanim: TfrmAcikRizaKayitTanim
  Left = 0
  Top = 0
  ClientHeight = 612
  ClientWidth = 714
  Caption = 'A'#231#305'k R'#305'za Muvafakatnamesi'
    ...
    object pgGenel: TUniTabSheet
      ...
      object groupIYS: TUniGroupBox
        ...
        object edIYSEMail: TUniDBCheckBox
          ...
          ValueChecked = 'E'
          ValueUnchecked = 'H'
          Caption = '  E-Posta G'#246'nd. Onay'#305
          ParentFont = False
          Font.Color = clNavy
          Font.OverrideDefaults = [ovFontHeight]
          TabOrder = 6
      ...
      object UniLabel9: TUniLabel
        ...
        Alignment = taRightJustify
        AutoSize = False
        Caption = #304'lgili Ki'#351'i T'#252'r'#252
        ParentFont = False
        Font.Color = clMaroon
        Font.OverrideDefaults = [ovFontHeight]
        TabOrder = 21
      ...
      object cbTumDepartman: TUniCheckBox
        Left = 97
        Top = 8
        Width = 29
        Height = 17
  ...
  object dsRiza: TUniDataSource
    DataSet = qRiza
    OnStateChange = dsRizaStateChange
    Left = 319
    Top = 199
  end
